...
\begin{document}
    ...
    En anticipation à ce problème, le message est alors envoyé sous une forme encodée, souvent plus longue, afin d'augmenter le taux de réussite quant à la bonne réception du message. De manière générale, on utilise \textbf{un dictionnaire} permettant d'encoder un message de $k$ bits sur $n$ bits. On définit le \textbf{taux du code} comme étant alors $\frac{k}{n}$. Les $n-k$ derniers bits (en \textcolor{blue}{bleu} sur la \autoref{fig:encodage}) sont appelés \textbf{bits de contrôle}.
    
    \begin{figure}[H]
        \centering
        \begin{equation*}
            \begin{bmatrix}[c|cccccc]
               00 & 1 & 0 & \color{blue} 1 & \color{blue} 0 & \color{blue} 1 & \color{blue} 0 \\
               01 & 1 & 1 & \color{blue} 1 & \color{blue} 1 & \color{blue} 1 & \color{blue} 1\\
               10 & 0 & 0 & \color{blue} 0 & \color{blue} 0 & \color{blue} 0 & \color{blue} 0\\
               11 & 0 & 1 & \color{blue} 0 & \color{blue} 1 & \color{blue} 0 & \color{blue} 1\\
            \end{bmatrix}
        \end{equation*}
    ...
    \begin{figure}[H]
        \centering
        \begin{equation*}
            \begin{bmatrix}[c|ccccccc]
               0000 & 0 & 0 & 0 & 0 & \color{blue} 0 & \color{blue} 0 & \color{blue} 0 \\
               0001 & 0 & 0 & 0 & 1 & \color{blue} 1 & \color{blue} 1 & \color{blue} 0 \\
               0010 & 0 & 0 & 1 & 0 & \color{blue} 0 & \color{blue} 1 & \color{blue} 1 \\
               0011 & 0 & 0 & 1 & 1 & \color{blue} 1 & \color{blue} 0 & \color{blue} 1 \\
               0100 & 0 & 1 & 0 & 0 & \color{blue} 1 & \color{blue} 0 & \color{blue} 1 \\
               0101 & 0 & 1 & 0 & 1 & \color{blue} 0 & \color{blue} 1 & \color{blue} 1 \\
               0110 & 0 & 1 & 1 & 0 & \color{blue} 1 & \color{blue} 1 & \color{blue} 0 \\
               0111 & 0 & 1 & 1 & 1 & \color{blue} 0 & \color{blue} 0 & \color{blue} 0 \\
            \end{bmatrix}
            \&
            \begin{bmatrix}[c|ccccccc]
               1000 & 1 & 0 & 0 & 0 & \color{blue} 1 & \color{blue} 1 & \color{blue} 1 \\
               1001 & 1 & 0 & 0 & 1 & \color{blue} 0 & \color{blue} 0 & \color{blue} 1 \\
               1010 & 1 & 0 & 1 & 0 & \color{blue} 1 & \color{blue} 0 & \color{blue} 0 \\
               1011 & 1 & 0 & 1 & 1 & \color{blue} 0 & \color{blue} 1 & \color{blue} 0 \\
               1100 & 1 & 1 & 0 & 0 & \color{blue} 0 & \color{blue} 1 & \color{blue} 0 \\
               1101 & 1 & 1 & 0 & 1 & \color{blue} 1 & \color{blue} 0 & \color{blue} 0 \\
               1110 & 1 & 1 & 1 & 0 & \color{blue} 0 & \color{blue} 0 & \color{blue} 1 \\
               1111 & 1 & 1 & 1 & 1 & \color{blue} 1 & \color{blue} 1 & \color{blue} 1 \\
            \end{bmatrix}
        \end{equation*}
