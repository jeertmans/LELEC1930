...
\begin{document}
    ...
    Comme $x(t)$ est complexe, il est commun de noter sa partie réelle $I$ (pour "In phase")
    \begin{equation}
        x_I(t) = \Re \left\{\sum\limits_{n=0}^{\infty}I(n) u(t-nT) \right\},
    \end{equation}
    et sa partie imaginaire $Q$ (pour "in Quadrature")
    \begin{equation}
    ...
    \begin{reponse}
        ...
        \item \begin{enumerate}
                ...
                \end{equation}
                \item Pour ce signal, la déviation de fréquence est de 75 kHz (voir (a)). De ce fait
                \begin{equation}
                    \beta = \frac{\num{75e3}}{\num{15e3}}=5.
                \end{equation}
